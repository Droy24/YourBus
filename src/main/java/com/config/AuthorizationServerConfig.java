...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory().withClient(propConfig.getWebAppClientId()).secret(propConfig.getWebAppApiSecret())
				...
				.authorizedGrantTypes("password", "authorization_code", "implicit", "client_credentials").and()
				.withClient(propConfig.getMobileAppClientId()).secret(propConfig.getMobileAppApiSecret())
				.authorities("CLIENT", "TRUSTED_CLIENT", "ROLE_CLIENT", "ROLE_TRUSTED_CLIENT")
				.scopes("read", "write", "trust")
				.authorizedGrantTypes("password", "authorization_code", "implicit", "client_credentials").and()
				.withClient(propConfig.getAdapterAppClientId()).secret(propConfig.getAdapterAppApiSecret())
				.authorities("CLIENT", "TRUSTED_CLIENT", "ROLE_CLIENT", "ROLE_TRUSTED_CLIENT")
				.scopes("read", "write", "trust")
