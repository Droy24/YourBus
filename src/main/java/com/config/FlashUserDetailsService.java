...
import com.flash.exception.BadRequestException;
...
public class FlashUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		User user = userService.findByEmailOrLoginNameAndActiveAndDeleted(username, username, Boolean.TRUE,
				Boolean.FALSE);
		...
		UserDetails userDetails = new FlashUserDetails(user.getUserId(), user.getEmail(), user.getPassword(),
				authorities);
		return userDetails;
	}
}